#===============================================================================
# Jokr Backend development environment settings file
#
# Nick Wrobel
# Created: 5/2/15
# Modified: 2/25/16
...
PRUNE_OLD_LOCALPOSTS = True # delete old localposts after time limit
PRUNE_OLD_MESSAGES = True # delete old messages after time limit
PRUNE_OLD_USERS = True # delete unused user accounts after time limit
PRUNE_STATIC_CONTENT = False # remove old static content from the 3rd party static content hoster
RATE_LIMIT_LOCAL = True # limit the rate a user posts to local
...
LIMIT_IMAGE_REPLIES = True # sets a limit on the max number of image replies in a thread
...
AWS_COGNITO_IDENTITY_POOL_ID = 'us-east-1:e4eec1e3-1a67-4b78-ae14-26cf5e791a5a'
AWS_COGNITO_DEVELOPER_PROVIDER_NAME = 'dev-gravity.ddns.net'
