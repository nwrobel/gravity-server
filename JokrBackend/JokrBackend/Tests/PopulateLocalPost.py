#===============================================================================
# Script to fill out the 'JokrBackend_localpost' table with some realistic
# data and save images. 
#
# To run this script, use 'python manage.py PopulateLocalPost'
#
# Nick Wrobel
# Created: 5/23/15
# Modified: 5/23/15 
...
# CONSTANTS
        ...
        tmpImgPath = settings.MEDIA_ROOT + '/local/tmpImg.jpg'
        tmpGzPath = settings.MEDIA_ROOT + '/local/tmpGzip.gz'
