...
class Session:
    ...
    def __init__(self,socket,owner,xmlns=None,peer=None):
        """ When the session is created it's type (client/server) is determined from the beginning.
            ...
            owner is the 'main' instance that have Dispatcher plugged into it and generally
    ...
    def terminate_stream(self,error=None,unregister=1):
        ...
        if self.subordinate_session:
            self.subordinate_session.terminate_stream(STREAM_REMOTE_CONNECTION_FAILED)
